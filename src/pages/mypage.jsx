            ...
            <Grid item xs={12} lg={8}>
                ...
                <Grid container sx={{marginTop: '10px'}}>
                    <Grid item xs={12} lg={6}>
                        <Box sx={{paddingRight: '20px', paddingLeft: '20px', marginRight: '5px', marginLeft: '5px', border:'2px solid rgb(76, 0, 153)', borderRadius: '15px'}}>
                            <TableContainer >
                    ...
                    <Grid item xs={12} lg={6}>
                        <Box sx={{paddingRight: '20px', paddingLeft: '20px', border:'2px solid rgb(76, 0, 153)', borderRadius: '15px'}}>
                            <TableContainer>
                                <Table aria-label="simple table">
                                    <TableHead>
                                        <TableRow>
